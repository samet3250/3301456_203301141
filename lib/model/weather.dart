...
class WeatherData{
  ...
  Future<void> getWeatherElements() async{
    var response = await http.get(Uri.parse("https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=be28d957903e30cf3e28696358b6e418&units=metric"),
);
    ...
    if(response.statusCode == 200){
      ...
      try{
        ...
        iconn=currentWeather["weather"][0]["icon"].toString();
        print(currentWeather["weather"][0]["description"].toString());
        print(currentWeather["name"].toString());
